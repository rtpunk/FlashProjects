...
package aecGames.helpers
{
	...
	public class Vector2D
	{
		...
		/**
		  ...
		  *  Generally used for debug purposes only.
		  *  @param graphics The Graphics instance to draw the vector on.
		  *  @param color The color of the line used for the vector.
		  */
		...
		/*
		  ...
		  *  Changing the length will change the x and y but not
		...
		*  Changing the angle changes the x and y but retains the same length.
		*/
		...
		/**
		 *  Normalizes this vector.  Equivalent to setting
		 *  the length to one, but more efficient.
		 *  @return Vector2D A reference to this vector.
		 */
		...
		/**
		  *  Ensures the length of the vector is no longer
		  *  than the given value.
		  *  @param max The maximum value this vector should be.
		  *  If length is larger than max, it will be truncated
		  *  to this value.
		  *  @return Vector2D A reference to this vector.
		  */
		...
		/**
		  *  Whether or not this vector is normalized,
		  *  i.e. its length is equal to one.
		...
		/**
		   ...
		   *  @return Number The dot product of this vector and
		...
		*/
		...
		/**
		 *  Determine if a given vector is to the right or left of this vector.
		...
		/**
		  ...
		  *  @return Vector2D A vector perpedicular to this vector
		  */
		...
		/**
		   ...
		   *  @return Number The distance from this vector to the
		...
		/**
		    *  Calculates the distance squared from this vector to
		*  another given vector.
		*  @param v2 A Vector2D instance.
		*  @return Number The distance squared from this vector =
		...
		*/
		 ...
		 *  Vector2D instance to hold the result.
		 *  @param v2 A Vector2D instance
		 *  @return Vector2D A new vector containing the
		...
		/**
		 *  Subtracts a vector from this vector, creating a
		 *  new Vector2D instance to hold the result.
		 *  @param v2 A Vector2D instance.
		 *  @result Vector2D A new vector containing the
		...
		/**
		  *  Multiplies the vector by a value, creating a
		  *  new Vector2D instance to hold the result.
		  *  @param v2 A Vector2D instance.
		  *  @result Vector2D A new vector containing the
		...
		/**
		  *  Divides this vector by a value, creating a new
		  *  Vector2D instance to hold the result.
		  *  @param v2 A Vector2D instance.
		  *  @return Vector2D A new vector containing the
		...
		/**
		  *  Indicates whether this vector and another
		  *  Vector2D instance are equal in value.
		  *  @param v2 A Vector2D instance.
		  *  @return Boolean True if the other vector is
		  *  equal to this one, false if not.
		  */
