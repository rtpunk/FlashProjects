//  MatchingButtoncontroller.as
//  For American Education Corporation
//  Programmer:  	Jeffrey Woidke
//  Created:		2011/03/27
//  Last Updated:	2011/03/28
//
//  This class controls the button actions for the matching game.
...
package aecGames.matchingGame
{
	...
	public class MatchingButtonController extends ButtonController
	{
		...
		public function MatchingButtonController(gameModel:Object, soundModel:Object)
		{
			...
			_directionsButton.x = 252;
			_directionsButton.y = 558;
			...
			_dReplayButton.x = 289;
			_dReplayButton.y = 558;
