...
package aecGames.mountainClimberGame
{
	...
	public class MountainClimberButtonController extends ButtonController
	{
		...
		public function MountainClimberButtonController(gameModel:Object, soundModel:Object)
		{
		...
		public override function buttonHandler(event:MouseEvent):void
		{
			...
			switch(event.target)
			{
				...
				case _startButton:
					...
					_gameModel.currentScreenName = GameModel.SCREEN_PLAYER_SELECT;
					break;
